...
**Current: A7 — `pallet-welfare`**. A10 was completed out of sequence at user request; next up returns to bounded counters, MetricSpec registry, pillar snapshots, and settlement score computation.
