...
def build():
    ...
    return {"schema":"bleavit.reference-model.v1","precision":"Python Decimal, 90 decimal digits (>=256-bit precision target)","lmsr_vectors":vectors_v1_v6(),"high_precision_corpus":{"b":"10000","samples":samples},"decision_scenarios":[{"name":"hurdle_met","delta":"0.06","hurdle":"0.05","outcome":"Adopt"},{"name":"below_hurdle","delta":"0.04","hurdle":"0.05","outcome":"Reject","reason":"HurdleNotMet"}],"ledger_scenarios":[{"name":"void_neutral_branch_usdc","input":"10.000000","payout":"5.000000"}],"welfare_vectors":[{"name":"settlement_full","w1":"1","w2":"1","score":str(settlement_score("1","1"))},{"name":"settlement_zero_floor","w1":"0","w2":"1","score":str(settlement_score("0","1"))}]}
